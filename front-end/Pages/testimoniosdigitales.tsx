...
import { ArrowBackIos, ArrowCircleRightOutlined, ArrowRight, Call, Email, LocationOn, Place, Schedule, WhatsApp } from '@mui/icons-material'
...
const Testimoniosdigitales: FunctionComponent = (props: any) => {
  const {
    history: navigation,
    match: { params },
  } = props
        ...
        <div data-title="div" id="principal" className={theme.header}>
          <Container className={theme.contenedorCertificados}>
            <div data-title="div" className={theme.divTituloCertificados}>
              ...
              <Typography variant="h1">Testimonios Digitales</Typography>
            </div>
          </Container>

          <Container className={theme.contenedorContenidoCertificados}>
            <div data-title="div" className={theme.divContenidoCertificados}>
              <Typography variant="h2">Acerca de los Testimonios Digitales</Typography>
              ...
              <NavLink to="/">
                <Button variant="text" color="primary" className={theme.buttonDosCertificados}>
                  Mas sobre Testimonios Digitales
                </Button>
              </NavLink>
            </div>
          </Container>
...
export default Testimoniosdigitales
