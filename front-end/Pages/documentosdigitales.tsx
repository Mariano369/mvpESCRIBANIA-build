...
const Documentosdigitales: FunctionComponent = (props: any) => {
  const {
    history: navigation,
    match: { params },
  } = props
            ...
            <div data-title="div" className={theme.divContenidoCertificados}>
              ...
              <NavLink to="/">
                <Button variant="text" color="primary" className={theme.buttonDosCertificados}>
                  Mas sobre Documentos Digitales
                </Button>
              </NavLink>
            </div>
          </Container>
...
export default Documentosdigitales
