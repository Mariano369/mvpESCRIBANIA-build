...
import { ArrowLeft, ArrowRight, Call, Email, LocationOn, Place, Schedule, WhatsApp } from '@mui/icons-material'
...
const Contacto: FunctionComponent = (props: any) => {
  const {
    history: navigation,
    match: { params },
  } = props
        ...
        <div data-title="div" id="principal" className={theme.header}>
          <Container className={theme.contenedorCertificados}>
            <div data-title="div" className={theme.divTituloCertificados}>
              ...
              <Typography variant="h1">Información de contacto</Typography>
            </div>
          </Container>

          <div data-title="div" className={theme.mapa}>
            <LeafLetMap position={[-31.947575, -65.193975]} zoom={15} scroll={true}>
              <Marker position={[-31.947575, -65.193975]}></Marker>
            </LeafLetMap>
          </div>

          <Container className={theme.contenedorContacto}>
            <div data-title="div" className={theme.divTituloContacto}>
              <Typography variant="h1">Dirección postal y ubicación</Typography>

              <Typography variant="h4">Escribanía Godoy</Typography>

              <Typography variant="h4">Lorem ipsum, 123, X5870 Villa Dolores, Córdoba, Argentina</Typography>

              <Typography variant="h4">El horario de oficina es de Lunes a Viernes, de 9:00 a.m a 9:00 pm Sabados y Domingo cerrado</Typography>
            </div>

            <div data-title="div" className={theme.divTituloContacto}>
              <Typography variant="h1">Información pública de contacto</Typography>

              <Typography variant="h4">(+54) 9 3544420123</Typography>
            </div>
          </Container>
        </div>
