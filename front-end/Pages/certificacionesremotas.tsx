...
const Certificacionesremotas: FunctionComponent = (props: any) => {
  const {
    history: navigation,
    match: { params },
  } = props
...
export default Certificacionesremotas
